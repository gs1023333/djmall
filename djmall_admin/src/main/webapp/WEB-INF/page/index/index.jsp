...
<frameset rows="18%,*">
	<frame src="<%=request.getContextPath()%>/index/top" name="top">
	<frameset cols="20%,*">
		<frame src="<%=request.getContextPath()%>/index/left" name="left">
		<frame src="<%=request.getContextPath()%>/index/right" name="right">
	</frameset>
</frameset>
