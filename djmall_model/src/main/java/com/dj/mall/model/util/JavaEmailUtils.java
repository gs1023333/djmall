...
public class JavaEmailUtils {
	...
	// 发件人的中文昵称
	private static final String nickname = "郭帅";
	// 发件人邮箱
	private static final String username = "318697314@qq.com";
	// 发件人在邮箱服务器中的授权码
	private static final String password = "pmkugcjuuofpbgfe";
	// 邮件的发送协议
	...
	public static void main(String[] args) {
		// 收件人邮箱地址
		String to = "18103419107@163.com";
		// 邮件的主题
		String subject = "HelloWorld";
		// 邮件正文的文本内容
		String body = "<a href=\'http://localhost:8080/ssm_work2/user/toLogin\'>点击激活</a>";
		// 封装邮件实体
		// 发送邮件
